...
def host_range_ping_tab(start, end):
    print(tabulate(host_range_ping(start, end, is_print=False), headers='keys', tablefmt="pipe", stralign="center"))


if __name__ == '__main__':
    list(host_ping(('192.168.88.1', 'ya.ru', 'blablabla')))
    host_range_ping('192.168.88.1', '192.168.88.3')
    host_range_ping_tab('192.168.88.1', '192.168.88.6')
